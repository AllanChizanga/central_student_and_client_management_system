<div>
    <div class="container-fluid p-0" style="margin-top: -18px;">
        <!-- Create Client Modal -->
        <div wire:ignore.self class="modal fade" id="createClientModal" tabindex="-1" aria-labelledby="createClientModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form wire:submit.prevent="create_client" class="modal-content app-card">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title app-text-primary" id="createClientModalLabel">Create New Client</h5>
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" wire:model.defer="company_name" id="company_name" class="form-control @error('company_name') is-invalid @enderror" placeholder="Enter company name">
                                @error('company_name')<small class="text-danger">{{ $message }}</small>@enderror
                            </div>

                            <div class="col-md-6">
                                <label for="industry" class="form-label app-text-primary">Industry</label>
                                <input type="text" wire:model.defer="industry" id="industry" class="form-control @error('industry') is-invalid @enderror" placeholder="e.g. Tech, Retail">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" wire:model.defer="country" id="country" class="form-control @error('country') is-invalid @enderror" placeholder="Enter country">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" wire:model.defer="occupation" id="occupation" class="form-control @error('occupation') is-invalid @enderror" placeholder="Enter occupation">
                            ...
                            {{-- Begin additional fields from CreateClientLivewire.php (41-54) --}}
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" wire:model.defer="phonenumber" id="phonenumber" class="form-control @error('phonenumber') is-invalid @enderror" placeholder="eg 263719203127">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit"
                                ...
                                wire:target="create_client"
                        >
                            <span wire:loading.remove wire:target="create_client" class="app-text-primary">Create Client</span>
                            <span wire:loading wire:target="create_client">
        ...
        <script>
            // Show create client modal when event dispatched
            window.addEventListener('view-create-client-modal', () => {
                var modal = new bootstrap.Modal(document.getElementById('createClientModal'));
                modal.show();
            });
            window.addEventListener('client-created-successfully', () => {
