<div>
    <div class="container-fluid p-0" style="margin-top: -18px;">
        ...
        <div wire:ignore.self class="modal fade" id="recordStudentPaymentModal" tabindex="-1" aria-labelledby="recordStudentPaymentModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form wire:submit.prevent="record_payment" class="modal-content app-card">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title app-text-primary" id="recordStudentPaymentModalLabel">
                            Record Payment
                        </h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label for="amount_paid" class="form-label app-text-primary">Amount</label>
                                <input type="number" step="0.01" wire:model.defer="amount_paid" id="amount_paid" class="form-control @error('amount_paid') is-invalid @enderror" min="0" placeholder="e.g. 1000.00">
        ...
        <script>
            // Show record student payment modal when event dispatched
            window.addEventListener('view-record-student-payment-modal', () => {
                var modal = new bootstrap.Modal(document.getElementById('recordStudentPaymentModal'));
                modal.show();
            });
            window.addEventListener('student-payment-recorded-successfully', () => {
                var modalEl = document.getElementById('recordStudentPaymentModal');
                ...
                notyf.success('Student payment recorded successfully');
            });
        </script>
    </div>
</div>
