<div>
    <div class="container-fluid p-0" style="margin-top: -18px;">
        <!-- Update Intake Modal -->
        <div wire:ignore.self class="modal fade" id="updateIntakeModal" tabindex="-1" aria-labelledby="updateIntakeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <form wire:submit.prevent="update_intake" class="modal-content app-card">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title app-text-primary" id="updateIntakeModalLabel">Update Intake</h5>
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" wire:model.defer="cohort" id="cohort" class="form-control @error('cohort') is-invalid @enderror" placeholder="Enter cohort (e.g. 2024A)">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit"
                                ...
                                wire:target="update_intake"
                        >
                            <span wire:loading.remove wire:target="update_intake" class="app-text-primary">Update Intake</span>
                            <span wire:loading wire:target="update_intake">
        ...
        <script>
            // Show update intake modal when event dispatched
            window.addEventListener('view-update-intake-modal', () => {
                var modal = new bootstrap.Modal(document.getElementById('updateIntakeModal'));
                modal.show();
            });
            window.addEventListener('intake-updated-successfully', () => {
                var modalEl = document.getElementById('updateIntakeModal');
                ...
                notyf.success('Intake updated successfully');
            });
        </script>
    </div>
</div>
