<div>
    <div class="container-fluid p-0" style="margin-top: -18px;">
        <!-- Update Course Modal -->
        <div wire:ignore.self class="modal fade" id="updateCourseModal" tabindex="-1" aria-labelledby="updateCourseModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <form wire:submit.prevent="update_course" class="modal-content app-card">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title app-text-primary" id="updateCourseModalLabel">Update Course</h5>
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label for="syllabus_pdf" class="form-label app-text-primary">Syllabus PDF <span class="text-muted small">(Upload to replace)</span></label>
                                ...
                                @if ($syllabus_pdf)
                                    <button type="button"
                                            wire:click="down_pdf"
                                            class="btn btn-link small d-block mt-1 p-0 app-text-primary"
                                    >
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit"
                                ...
                                wire:target="update_course"
                        >
                            <span wire:loading.remove wire:target="update_course" class="app-text-primary">Update Course</span>
                            <span wire:loading wire:target="update_course">
        ...
        <script>
            // Show update course modal when event dispatched
            window.addEventListener('view-update-course-modal', () => {
                var modal = new bootstrap.Modal(document.getElementById('updateCourseModal'));
                modal.show();
            });
            window.addEventListener('course-updated-successfully', () => {
                var modalEl = document.getElementById('updateCourseModal');
